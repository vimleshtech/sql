...
-MS SQL Server File System Type:
	-.mdf	: main data file		: default 
	-.ldf	: log data file			: default 
...
1. DDL : Data Defintion Language
	-create		: create new object(table, function etc.), new structure 
	-alter		: modify physical structure
	-drop		: remove structure  , remove object/column
	-truncate	: remove all rows means data , but structure will remain same 
2. DML : Data Manipulation Language
	-insert	: save / add new row
	-update	: modify in existing data 
	-delete	: remove row (either with condition or all data)
